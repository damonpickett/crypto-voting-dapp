      ...
      <div className="modal-canvas">
        ...
        <div className="modal-body">
          <ul>
              ...
              <ol>Connect your wallet to Polygon's Mumbai testnet</ol>
              ...
              <ol>Select 'Up' or 'Down' to vote as to whether you believe the value of the given currency will rise or fall</ol>
        ...
        <div className="modal-body">
          <ul>
              ...
              <ol>This application was built by following a free <a href='https://www.youtube.com/watch?v=MI_Se26Sfmo' target='_blank' rel='noreferrer'>tutorial</a> provided by <a href='https://moralis.io/' target='_blank' rel='noreferrer'>Moralis</a></ol>
          </ul>
        </div>
